...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // This clears the Next.js client-side router cache so the layout (Header) fetches the new user session.
        ...
        <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-[var(--color-charcoal)]">
              Log in to access your GST courses and dashboard.
            </p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                <label className="block text-sm font-medium text-[var(--color-text-dark)]">Password</label>
